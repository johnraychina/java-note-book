...
jQuery(function ($) {
  ...
  $('article > #container > section > h2').each(function() {
	...
	$('#dialog ul:first').append('<li><a href="#' + $(anchor).attr("id") + '"><img align="absmiddle" src="/webfolder/technetwork/tutorials/obe/java/G1GettingStarted/css/images/right_arrow_bullet.gif">' + $(this).text() + '</a></li>');
	if ($(this).parent('section').find('section').length > 0) {
      ...
      $(this).parent("section").find('section > h3').each(function(){
		...
		$('#dialog ul:first > ul:last').append('<li><a href="#' + $(anchor).attr("id") + '"><img align="absmiddle" src="/webfolder/technetwork/tutorials/obe/java/G1GettingStarted/css/images/right_arrow_bullet.gif">' + $(this).text() + '</a></li>');                    
      });
    } // end if
  ...
  $(".ScreenShot").each(function() {
	...
	$(this).hover(
      function() {
	    if ($(this).hasClass("view_icon")) {
          $(this).attr("src", "/webfolder/technetwork/tutorials/obe/java/G1GettingStarted/css/images/show_image_h.png");
	    }
	  },
	  function() {
	    if ($(this).hasClass("view_icon")) {
          $(this).attr("src", "/webfolder/technetwork/tutorials/obe/java/G1GettingStarted/css/images/show_image_v.png");
	    }
	  }
	);
	$(this).click(function(e, showImage) {
	  ...
	  if (showImage == "true" || !$(this).hasClass("view_icon")) {
	    ...
	    if (showImage != "false") {
          $(this).attr("src", "/webfolder/technetwork/tutorials/obe/java/G1GettingStarted/css/images/show_image_c.png");
	    }
		else {
			delay = 0;
		}
